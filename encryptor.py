...
from PyQt5.QtWidgets import QWidget, QApplication, QMainWindow, QPushButton, QLabel, QVBoxLayout    #GUI
import resource_rc      #GUI
from Crypto.Cipher import AES       #encryptor
from Crypto.Random import get_random_bytes      #encryptor random key generation
from ewidget import Ui_eform        #encryption widget
from dwidget import Ui_dform        #decryption widget

try:                                                    #To make icon visible in task bar and start
...
class Ui_MainWindow(object):                                            #Main WIndow of Hero Encryptor
    def setupUi(self, MainWindow):
        ...
        self.next.clicked.connect(self.chosen)              #next button clicked
        self.readme.clicked.connect(self.readit)            #readme button clicked
    ...
    def chosen(self):                               #see choice and go to respective widget
        if self.combom.currentText() == "Encrypt":
            self.econnect()
        elif self.combom.currentText() == "Decrypt":
            self.dconnect()
        else:
            self.popup()                            #error popup


    def econnect(self):
        self.eform = QtWidgets.QWidget()
        self.ui = Ui_eform()
        self.ui.setupUi(self.eform)
        self.eform.show()
    ...
    def readit(self):
        import os
        os.system('notepad.exe ' + 'read_me.txt')
...
if __name__ == "__main__":
    ...
    app.setWindowIcon(QtGui.QIcon('hero1.ico'))
